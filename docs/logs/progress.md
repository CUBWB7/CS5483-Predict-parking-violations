...
| 模型 | v1 OOF | v2 OOF | v3 OOF | v4 OOF | v5 OOF | v6 OOF |
|------|--------|--------|--------|--------|--------|--------|
| LightGBM | 0.5815 | 0.5959 | **0.6322** | 0.6322 | 0.6315 | 0.6098 ❌ |
| XGBoost | 0.5870 | 0.5994 | **0.6379** | 0.6379 | 0.6382 | 0.6375 |
| CatBoost | — | — | 0.5728 | **0.6175** | 0.6175 | 0.6175 |
| **Ensemble** | 0.5880 | 0.6012 | **0.6408** | **0.6408** | **0.6408** | 0.6377 ❌ |
| Platform | 0.5222 | 0.5338 | **0.5620** | 待提交 | 待提交 | 0.5618 |
