...
### Step 12：Constrained Re-Optuna → v9 ⏳ Awaiting Platform

**日期**: 2026-04-06  
**状态**: 已完成训练（GPU 服务器，~2h），等待平台提交
...
1. **ensemble_v8a.csv**（Step 11A，全量训练 + M1-5 TE，OOF 不变）— 最优先
2. **ensemble_v9.csv**（Step 12，强正则化 + 全量 TE）— 次之
3. **ensemble_v9a.csv**（Step 12 + M1-5 TE 叠加版）— 视 v8a/v9 结果决定
...
| 模型 | v3 OOF | v7 OOF | v8a OOF | v9 OOF |
|------|--------|--------|---------|--------|
| LightGBM | 0.6322 | 0.6336 | 0.6336 | 0.6273 |
| XGBoost | 0.6379 | **0.6403** | 0.6403 | 0.6283 |
| **Ensemble** | 0.6408 | **0.6429** | **0.6429** | 0.6326 |
| M1-5 OOF | 0.6492 | **0.6515** | 0.6515 | 0.6419 |
| Platform | 0.5620 | **0.5636** | ⏳ pending | ⏳ pending |
